...
class Absence extends Pivot
{
    ...
    public static function getAbsencesOfThisStudentBetween($start_date, $end_date, $student_id)
    {
        return self::join('study', 'study.study_id', '=', 'absences.study_id')
            ->join('sessions', 'sessions.session_id', '=', 'study.session_id')->Where('student_id', '=', $student_id)->whereBetween('sessions.session_date', [$start_date, $end_date])->orWhere('session_date', 'like', '%' . $end_date . '%')->get();
    }
