...
class justification_controller extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            $validator=Validator::make($request->all(),[
                ...
                "justification" => ['required','not_in:undefined'],
    ...
    public function update(Request $request)
    {
        ...
        $absanceOfStudent = Absence::getAbsencesOfThisStudentBetween($jutification_date['start_at'], $jutification_date['end_at'], $request->student_id);

        foreach ($absanceOfStudent as  $value) {
            $value->update([
                "status" => $newStatus
            ]);
        }
