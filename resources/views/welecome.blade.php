...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="container">
            ...
            <a class="navbar-brand logo-text page-scroll" href="index.php">ATTE<span style='color:rgba(0,172,193,1);'>NTIC</span></a>
        ...
        <div id="details-lightbox" class="lightbox-basic zoom-anim-dialog mfp-hide">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="list-unstyled li-space-lg">
                    <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">Request your account login details from the administrator</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">login with your Email and Passwort</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">Thats all!</div>
                        </li>
                        <!-- <li class="media">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading">Don't hesitate to send your questions through the contact form or <a class="blue no-line" href="mailto:contact@attentic.com">contact@attentic.com</a></p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
