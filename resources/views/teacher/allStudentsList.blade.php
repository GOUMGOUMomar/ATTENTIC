                ...
                <tbody>
                  ...
                  @if($key < count($group)) @foreach($study->group_Teaching->group->students as $student)
                    ...
                    <tr>
                      ...
                      <td><select name="status[{{$student->student_id}}][{{$study->session->session_date}}]" class="form-control statusController" data-study-date="{{$study->session->session_date}}" data-student-id="{{$student->student_id}}">
                    ...
                    <tr>
                      ...
                      @foreach($studies as $key =>$study)
                      <td>
                        <select required name="status[{{$student->student_id}}][{{$study->session->session_date}}]" class="form-control statusController" data-study-date="{{$study->session->session_date}}" data-student-id="{{$student->student_id}}">
                          <option class="text-success" value='{{$student_status["present"]}}'>Present</option>
